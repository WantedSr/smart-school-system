 ...
 * @LastEditTime: 2021-03-16 22:42:52
...
> > > **财务管理**：所有模块
> > > **办公OA**：流程设置模块
> > > **学生管理**：学期分班、成绩填报、考勤管理、成绩汇总、学生档案（不含证书图片）、奖惩管理
> > > **教师管理**：入职登记、教师档案（不含证书图片）、我的档案（不含证书图片）
> > > **校产管理**：所有模块
> > > **基础设置**：所有模块
> > > **系统设置**：所有模块
> > > **数据中心**：*未完成*
