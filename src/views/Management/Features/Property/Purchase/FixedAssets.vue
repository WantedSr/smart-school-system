<template>
  <div class="FixedAssets">
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template v-slot="scope">
            {{scope.row.num * scope.row.single_price}}
          </template>
        </el-table-column>
        <el-table-column
          prop="do"
          ...
          <template v-slot="scope">
            ...
            <el-button @click="see(scope.row.id)" size="small" type="" :underline="false">查看</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
    ...
    <el-dialog title="收货地址" :visible.sync="lookAsset">
      ...
      <el-form ref="form" :rules="rules" :model="form" label-width="80px">
        ...
        <el-form-item prop="asset_id" label="资产编号">
          <el-input v-model="form.asset_id"></el-input>
        </el-form-item>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="lookAsset = false">确 定</el-button>
      </div>
    </el-dialog>
