  ...
  <div class="SelSemester">
    ...
    <div style="margin-bottom: 24px">
      <el-form :inline="true" label-position="left" label-width="80px" :model="form" class="demo-form-inline">
        ...
        <el-form-item label="">
          <el-select size="small" v-model="form.dormroom" placeholder="选择宿舍">
    ...
    <div class="see">
      <el-dialog title="收货地址" :visible.sync="dialogFormVisible">
        <el-form ref="form" :model="form2" :rules="rules" label-width="100px">
          <el-form-item prop="class" label="宿舍">
            <el-input size="small" v-model="form2.dormroom_name" placeholder="宿舍"></el-input>
          </el-form-item>
          <el-form-item prop="teacher" label="宿管">
            <el-input size="small" v-model="form2.dormitory_name" placeholder="宿管"></el-input>
          </el-form-item>
...
export default {
  ...
  methods:{
    ...
    onSubmit(){
      ...
      if(this.form.dormroom != 'all'){
        if(this.form.week != 'all'){
          obj['dormroom'] = this.form.dormroom;
          obj['week'] = this.form.week;
        }else{
          obj['dormroom'] = this.form.dormroom
        }
      }else if(this.form.build != 'all'){
        if(this.form.week != 'all'){
          obj['build'] = this.form.build;
          obj['week'] = this.form.week;
        }else{
          obj['build'] = this.form.build;
        }
