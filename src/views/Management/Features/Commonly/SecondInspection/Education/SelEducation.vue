            ...
            <ul>
              <li class="table-item">
                ...
                <div class="item-content">
                  <el-input :disabled="true" type="textarea" v-model="item.teach" :row="2" size="mini"></el-input>
                </div>
                <div class="item-plus">
                  <el-input :disabled="true" type="number" :max="25" :min="0" v-model="item.teach_plus" placeholder="加分" size="mini"></el-input>
                </div>
                <div class="item-minus">
                  <el-input :disabled="true" type="number" :max="-25" :min="0" v-model="item.teach_minus" placeholder="扣分" size="mini"></el-input>
                </div>
                <div class="item-reason">
                  <el-input :disabled="true" type="textarea" v-model="item.teach_reason" :row="2" size="mini"></el-input>
                </div>
                <div class="score">
                  得分：{{ 50 + parseInt(item.teach_plus) + parseInt(item.teach_minus) }}
                </div>
              </li>
              <li class="table-item">
                <div class="item-title2">
                ...
                <div class="item-content">
                  <el-input :disabled="true" type="textarea" v-model="item.study" placeholder="" :row="2" size="mini"></el-input>
                </div>
                <div class="item-plus">
                  <el-input :disabled="true" type="number" :max="25" :min="0" v-model="item.study_plus" placeholder="加分" size="mini"></el-input>
                </div>
                <div class="item-minus">
                  <el-input :disabled="true" type="number" :max="-25" :min="0" v-model="item.study_minus" placeholder="扣分" size="mini"></el-input>
                </div>
                <div class="item-content">
                  <el-input :disabled="true" type="textarea" v-model="item.study_reason" placeholder="" :row="2" size="mini"></el-input>
                </div>
                <div class="score">
                  得分：{{ 10 + parseInt(item.study_plus) + parseInt(item.study_minus) }}
                </div>
              </li>
              <li class="table-item">
                <div class="item-title2">
                ...
                <div class="item-content">
                  <el-input :disabled="true" type="textarea" v-model="item.health" placeholder="" :row="2" size="mini"></el-input>
                </div>
                <div class="item-plus">
                ...
                <div class="item-content">
                  <el-input :disabled="true" type="textarea" v-model="item.health_reason" placeholder="" :row="2" size="mini"></el-input>
                </div>
                <div class="score">
                  得分：{{ 10 + parseInt(item.health_plus) + parseInt(item.health_minus) }}
                </div>
              </li>
              <li class="table-item">
                <div class="item-title2">
                ...
                <div class="item-content">
                  <el-input :disabled="true" type="textarea" v-model="item.phone" placeholder="" :row="2" size="mini"></el-input>
                </div>
                <div class="item-plus">
                  <el-input :disabled="true" type="number" :max="25" :min="0" v-model="item.phone_plus" placeholder="加分" size="mini"></el-input>
                </div>
                <div class="item-minus">
                  <el-input :disabled="true" type="number" :max="-25" :min="0" v-model="item.phone_minus" placeholder="扣分" size="mini"></el-input>
                </div>
                <div class="item-content">
                  <el-input :disabled="true" type="textarea" v-model="item.phone_reason" placeholder="" :row="2" size="mini"></el-input>
                </div>
                <div class="score">
                  得分：{{ 10 + parseInt(item.phone_plus) + parseInt(item.phone_minus) }}
                </div>
              </li>
              <li class="table-item">
                <div class="item-title2">
                ...
                <div class="item-content">
                  <el-input :disabled="true" type="textarea" v-model="item.inspection_reason" placeholder="" :row="2" size="mini"></el-input>
                </div>
                <div class="score">
              ...
              <li class="table-item">
                ...
                <div class="item-content">
                  <el-input :disabled="true" type="textarea" v-model="item.other_reason" placeholder="" :row="2" size="mini"></el-input>
                </div>
                <div class="score">
...
export default {
  ...
  computed:{
    ...
    getScore(){
      return (item)=>{
        let score = 50 + parseInt(item.teach_plus) + parseInt(item.teach_minus);
        score += 10 + parseInt(item.study_plus) + parseInt(item.study_minus);
        score += 10 + parseInt(item.health_plus) + parseInt(item.health_minus);
        score += 10 + parseInt(item.phone_plus) + parseInt(item.phone_minus);
