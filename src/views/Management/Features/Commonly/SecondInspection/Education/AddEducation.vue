<template>
  <div class="subpage"
    ...
    <div class="add_record">
      <div class="pagehead">
        <h1>{{ getDate(new Date()) }} 填写教务处督查</h1>
      </div>
            ...
            <ul>
              <li class="table-item">
                ...
                <div class="item-content">
                  <el-input type="textarea" v-model="item.teach" placeholder="输入督查情况" :row="2" size="mini"></el-input>
                </div>
                <div class="item-plus">
                  <el-input type="number" :max="25" :min="0" v-model="item.teach_plus" placeholder="加分" size="mini"></el-input>
                </div>
                <div class="item-minus">
                  <el-input type="number" :max="-25" :min="0" v-model="item.teach_minus" placeholder="扣分" size="mini"></el-input>
                </div>
                <div class="item-content">
                  <el-input type="textarea" v-model="item.teach_reason" placeholder="输入扣分原因" :row="2" size="mini"></el-input>
                </div>
              </li>
              <li class="table-item">
                <div class="item-title2">
                ...
                <div class="item-content">
                  <el-input type="textarea" v-model="item.study" placeholder="输入督查情况" :row="2" size="mini"></el-input>
                </div>
                <div class="item-plus">
                  <el-input type="number" :max="25" :min="0" v-model="item.study_plus" placeholder="加分" size="mini"></el-input>
                </div>
                <div class="item-minus">
                  <el-input type="number" :max="-25" :min="0" v-model="item.study_minus" placeholder="扣分" size="mini"></el-input>
                </div>
                <div class="item-content">
                  <el-input type="textarea" v-model="item.study_reason" placeholder="输入扣分原因" :row="2" size="mini"></el-input>
                </div>
              </li>
              <li class="table-item">
                <div class="item-title2">
                ...
                <div class="item-content">
                  <el-input type="textarea" v-model="item.health_reason" placeholder="输入扣分原因" :row="2" size="mini"></el-input>
                </div>
              </li>
              <li class="table-item">
                <div class="item-title2">
                ...
                <div class="item-content">
                  <el-input type="textarea" v-model="item.phone" placeholder="输入督查情况" :row="2" size="mini"></el-input>
                </div>
                <div class="item-plus">
                  <el-input type="number" :max="25" :min="0" v-model="item.phone_plus" placeholder="加分" size="mini"></el-input>
                </div>
                <div class="item-minus">
                  <el-input type="number" :max="-25" :min="0" v-model="item.phone_minus" placeholder="扣分" size="mini"></el-input>
                </div>
                <div class="item-content">
                  <el-input type="textarea" v-model="item.phone_reason" placeholder="输入扣分原因" :row="2" size="mini"></el-input>
                </div>
              </li>
              <li class="table-item">
                <div class="item-title2">
                ...
                <div class="item-content">
                  <el-input type="textarea" v-model="item.inspection_reason" placeholder="输入扣分原因" :row="2" size="mini"></el-input>
                </div>
              </li>
              <li class="table-item">
                <div class="item-title2">
                ...
                <div class="item-content">
                  <el-input type="textarea" v-model="item.other_reason" placeholder="输入扣分原因" :row="2" size="mini"></el-input>
                </div>
              </li>
            </ul>
          </div>
  ...
  methods:{
    ...
    onSubmit(){
      ...
      $.each(arr, (i,v)=>{ 
        ...
        v.teach_plus = v.teach_plus == '' ? 0 : v.teach_plus;
        v.teach_minus = v.teach_minus == '' ? 0 : v.teach_minus;
        v.study_plus = v.study_plus == '' ? 0 : v.study_plus;
        v.study_minus = v.study_minus == '' ? 0 : v.study_minus;
        v.inspection_plus = v.inspection_plus == '' ? 0 : v.inspection_plus;
        v.inspection_minus = v.inspection_minus == '' ? 0 : v.inspection_minus;
        v.phone_plus = v.phone_plus == '' ? 0 : v.phone_plus;
        v.phone_minus = v.phone_minus == '' ? 0 : v.phone_minus;
      ...
      requestAjax({
        ...
        success:(res)=>{
          ...
          if(errarr.length <= 0){
            ...
            // 日志写入
            let obj = {
              content: "教务处督查填写 学期：" + this.$store.state.semester + " 日期：" + new Date().getTime(),
              type: "添加记录",
              model: "教务处督查",
