    ...
    <div class="sel">
      <el-form label-position="left" ref="sel" :rules="rules" label-width="100px" :model="sel" class="demo-form-inline">
        <el-form-item prop="option_id" label="选项代码">
          <el-input style="width: 250px" v-model="sel.option_id" placeholder="选项代码"></el-input>
        </el-form-item>
        <el-form-item prop="option_name" label="选项名称">
          <el-input style="width: 250px" v-model="sel.option_name" placeholder="选项名称"></el-input>
        </el-form-item>
        ...
        <el-form-item prop="score" label="分数">
          <el-input type="number" style="width: 400px" v-model="sel.score" placeholder="分数"></el-input>
        </el-form-item>
        <el-form-item label="备注">
          <el-input style="width: 400px" v-model="sel.remark" placeholder="备注"></el-input>
        </el-form-item>
        <el-form-item label="">
  ...
  data(){
    return{
      ...
      rules:{
        ...
        score: [
          { required: true, message: '请选择考勤分值', trigger: 'blur' }
        ],
        type: [
        ...
        if (valid) {
          ...
          requestAjax({
            ...
            success:(res)=>{
              ...
              if(res){
                this.$message({
                  message: '恭喜你，修改宿舍考勤选项成功',
                  type: 'success'
                });
              
                // 日志写入
                let obj = {
                  content: "修改宿舍考勤选项 "+ this.sel.option_id,
                  type: "修改记录",
                  model: "宿舍考勤选项模块",
