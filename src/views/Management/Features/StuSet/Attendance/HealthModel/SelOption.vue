<template>
  <div class="SelCampus">
    ...
    <div class="AddOptionTable box">
      <el-table
        size="small"
        :data="tableData.filter(data => !search || data.health_id.toLowerCase().includes(search.toLowerCase()) || data.health_name.toLowerCase().includes(search.toLowerCase()))"
        ref="multipleTable"
        tooltip-effect="dark"
