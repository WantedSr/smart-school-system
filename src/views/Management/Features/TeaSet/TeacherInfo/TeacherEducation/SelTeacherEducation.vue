<template>
  <div class="selTeacherInfo">
    ...
    <div class="teaInfoTable box">
      <el-table
        :data="tableData.filter(data => !search || data.teacher_name.toLowerCase().includes(search.toLowerCase()) || data.graduated_school.toLowerCase().includes(search.toLowerCase()))"
        ref="multipleTable"
        tooltip-effect="dark"
