    ...
    <div class="sel_add">
      <el-form label-position="left" ref="sel_add" :rules="rules" label-width="120px" :model="sel_add" class="demo-form-inline">
        <el-form-item prop="campus_name" label="校区名称">
          <el-input style="width: 250px" v-model="sel_add.campus_name" placeholder="校区名称"></el-input>
        </el-form-item>
        <el-form-item prop="campus_school" label="所在学校">
          <el-select @change="getCampusId" v-model="sel_add.campus_school" placeholder="请选择所在学校">
        ...
        <el-form-item prop="campus_position" v-if="city != '' && areaData != ''" label="校区位置-区/县">
          <el-select v-model="sel_add.campus_position" placeholder="请选择区/县">
        ...
        <el-form-item prop="campus_id" label="校区代码">
          <el-input style="width: 250px" v-model="sel_add.campus_id" placeholder="年级代码"></el-input>
        </el-form-item>
        <el-form-item label="">
          ...
          requestAjax({
            ...
            success:(res)=>{
              if(res){
                ...
                // 日志写入
                let obj = {
                  content: "添加校区信息 "+ this.sel_add.campus_id,
                  type: "添加记录",
                  model: "校区模块",
