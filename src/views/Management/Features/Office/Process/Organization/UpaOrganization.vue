  ...
  methods:{
    ...
    onUpa(formName){
      this.$refs[formName].validate((valid) => {
        if (valid) {
          if(this.form.department != this.department){
            this.form.sponsor = '';
            this.form.department_responsible = '';
            this.form.course_responsible = '';
          }
          this.loading = true;
          requestAjax({
            type: "post",
            ...
            success:(res)=>{
              ...
              if(res){
                ...
                // 日志写入
                let obj = {
                  content: "修改组织架构信息 id:"+ this.form.organization_id,
                  type: "添加记录",
                  model: "修改架构模块",
