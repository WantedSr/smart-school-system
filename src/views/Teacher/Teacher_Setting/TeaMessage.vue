<template>
  <div class="message">
    <el-form :model="message" label-width="100px" class="demo-ruleForm">
      ...
      <el-form-item label="展示薪资" prop="school">
        <el-switch @change="toChang" active-value="1" inactive-value="0" v-model="message.money"></el-switch>
      </el-form-item>
    </el-form>
  </div>
</template>
  ...
  data(){
    return {
      message:{
        ...
        money: JSON.parse(this.userData)['msgSet'].split(',')[2],
      }
    }
  },
  computed:{
